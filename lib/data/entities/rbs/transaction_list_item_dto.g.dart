...
_$_TransactionListItemDto _$$_TransactionListItemDtoFromJson(
        Map<String, dynamic> json) =>
    _$_TransactionListItemDto(
...
Map<String, dynamic> _$$_TransactionListItemDtoToJson(
        _$_TransactionListItemDto instance) =>
    <String, dynamic>{
